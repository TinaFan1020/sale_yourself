...
import ML.Alternative.jdk.midi.Sequencer;
import ML.Alternative.jdk.midi.Synthesizer;
import ML.Alternative.jdk.midi.Transmitter;
import ML.Alternative.jdk.midi.Receiver;
import ML.Alternative.sample.Clip;
import ML.Alternative.sample.Port;
import ML.Alternative.sample.SourceDataLine;
import ML.Alternative.sample.TargetDataLine;
/**
...
public final class JDK13Services {
    ...
    public static synchronized List getProviders(Class serviceClass) {
        ...
        //Log.i("in get provider",cache.toString());
        if (cache == null) {
            Log.i("in get provider","cache==null");
        ...
        if (cache.providers == null ||
            ...
            System.out.println("cache .providers == null");
