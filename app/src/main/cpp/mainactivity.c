...
double updatecicbuffer(int datain, int f, int pos){
    int i;
...
Java_com_example_soundkeyboard_MainActivity_getbaseband(JNIEnv *env, jobject instance, jshortArray data_,
    ...
    int datapoint;
    double dataresult[4];
    jshort *data = (*env)->GetShortArrayElements(env, data_, NULL);
    jdouble *outdata = (*env)->GetDoubleArrayElements(env, outdata_, NULL);
    ...
    (*env)->ReleaseShortArrayElements(env, data_, data, 0);
    (*env)->ReleaseDoubleArrayElements(env, outdata_, outdata, 0);
...
JNIEXPORT jstring JNICALL
Java_com_example_soundkeyboard_MainActivity_initdownconvert(JNIEnv *env, jobject instance, jint samplerate,
                                                     jint numfreq, jdoubleArray wavfreqs_) {
    char result[255];
    int f,i,n;
    jdouble *wavfreqs = (*env)->GetDoubleArrayElements(env, wavfreqs_, NULL);
    ...
    (*env)->ReleaseDoubleArrayElements(env, wavfreqs_, wavfreqs, 0);
...
JNIEXPORT jstring JNICALL
Java_com_example_soundkeyboard_MainActivity_removedc(JNIEnv *env, jobject instance, jdoubleArray data_,
    ...
    int max_id,min_id;
    jdouble *data = (*env)->GetDoubleArrayElements(env, data_, NULL);
    jdouble *data_nodc = (*env)->GetDoubleArrayElements(env, data_nodc_, NULL);
    jshort *outdata = (*env)->GetShortArrayElements(env, outdata_, NULL);
    ...
    (*env)->ReleaseDoubleArrayElements(env, data_, data, 0);
    (*env)->ReleaseDoubleArrayElements(env, data_nodc_, data_nodc, 0);
    (*env)->ReleaseShortArrayElements(env, outdata_, outdata, 0);
...
JNIEXPORT jstring JNICALL
Java_com_example_soundkeyboard_MainActivity_getdistance(JNIEnv *env, jobject instance, jdoubleArray data_,
    ...
    jdouble *data = (*env)->GetDoubleArrayElements(env, data_, NULL);
    jdouble *outdata = (*env)->GetDoubleArrayElements(env, outdata_, NULL);
    jdouble *dischange = (*env)->GetDoubleArrayElements(env, dischange_, NULL);
    jdouble *freqpow = (*env)->GetDoubleArrayElements(env, freqpow_, NULL);
    ...
    (*env)->ReleaseDoubleArrayElements(env, dischange_, dischange, 0);
    (*env)->ReleaseDoubleArrayElements(env, freqpow_, freqpow, 0);
...
JNIEXPORT jstring JNICALL
Java_com_example_soundkeyboard_MainActivity_getidftdistance(JNIEnv *env, jobject instance,
...
JNIEXPORT jstring JNICALL
Java_com_example_soundkeyboard_MainActivity_calibrate(JNIEnv *env, jobject instance, jdoubleArray data_) {
    char result [255];
    double fftx[nfft];
    double ffty[nfft];
...
JNIEXPORT jstring JNICALL
Java_com_example_soundkeyboard_MainActivity_testcc(JNIEnv *env, jobject thiz, jchar c) {
    char result[1024];
    sprintf(result,"test");
    return (*env)->NewStringUTF(env, result);
}